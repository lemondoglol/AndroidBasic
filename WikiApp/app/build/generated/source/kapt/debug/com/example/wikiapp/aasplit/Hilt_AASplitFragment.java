...
public abstract class Hilt_AASplitFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AASplitFragment() {
    super();
  }

  Hilt_AASplitFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AASplitFragment_GeneratedInjector) this.generatedComponent()).injectAASplitFragment(UnsafeCasts.<AASplitFragment>unsafeCast(this));
    }
  }
