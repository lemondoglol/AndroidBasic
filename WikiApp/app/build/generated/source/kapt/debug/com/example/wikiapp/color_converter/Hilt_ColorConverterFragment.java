...
public abstract class Hilt_ColorConverterFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ColorConverterFragment() {
    super();
  }

  Hilt_ColorConverterFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ColorConverterFragment_GeneratedInjector) this.generatedComponent()).injectColorConverterFragment(UnsafeCasts.<ColorConverterFragment>unsafeCast(this));
    }
  }
