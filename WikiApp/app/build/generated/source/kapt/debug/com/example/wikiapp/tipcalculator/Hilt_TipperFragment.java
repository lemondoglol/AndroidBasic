...
public abstract class Hilt_TipperFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_TipperFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((TipperFragment_GeneratedInjector) this.generatedComponent()).injectTipperFragment(UnsafeCasts.<TipperFragment>unsafeCast(this));
    }
  }
