...
public abstract class Hilt_ClinicianSaverFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ClinicianSaverFragment() {
    super();
  }

  Hilt_ClinicianSaverFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ClinicianSaverFragment_GeneratedInjector) this.generatedComponent()).injectClinicianSaverFragment(UnsafeCasts.<ClinicianSaverFragment>unsafeCast(this));
    }
  }
